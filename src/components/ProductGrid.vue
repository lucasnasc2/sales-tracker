      ...
      >
        ...
        >
          <v-img
            ...
            cover
          >
            <v-card-title :style="!item.img ? 'color: black;' : ''">{{
              item.name
            }}</v-card-title>
            <v-card-subtitle :style="!item.img ? 'color: black;' : ''">{{
              item.description
            }}</v-card-subtitle>
          </v-img>
          <v-list
          ...
          >
            <v-list-item density="compact" :subtitle="item.category">
              <template v-slot:append
                >{{ $globals.currency }}{{ item.price }}</template
              >
            </v-list-item>
          </v-list>
        </v-card>
  ...
  computed: {
    colorPalette() {
      return generateAnalogousColorPalette(
        getColorByValuePath(this.$globals.secondaryColor),
