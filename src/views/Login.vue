...
export default defineComponent({
  ...
  data() {
    return {
      password: "",
      email: "",
      filteredItems: [{ name: "asdbs", category: "camisetas", price: 3 }, { name: "asdbs", category: "camisetas", price: 3 }, { name: "asdbs", category: "camisetas", price: 3 }, { name: "asdbs", category: "camisetas", price: 3 }]
    };
  },
  methods: {
    async login() {
